class Zap < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/voidash/zapper.cloud/releases/download/v0.7.0/zap-darwin-arm64"
      ...
      url "https://github.com/voidash/zapper.cloud/releases/download/v0.7.0/zap-darwin-x86_64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/voidash/zapper.cloud/releases/download/v0.7.0/zap-linux-arm64"
      ...
      url "https://github.com/voidash/zapper.cloud/releases/download/v0.7.0/zap-linux-x86_64"
